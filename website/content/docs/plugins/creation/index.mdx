...
~> Note: Registering a remote plugin's plugin documentation requires the use of [Packer's plugin docs configuration](https://github.com/hashicorp/packer-plugin-scaffolding/docs).
...
A GitHub workflow has been added to [packer-plugin-scaffolding](https://github.com/hasicorp/packer-plugin-scaffolding) that
